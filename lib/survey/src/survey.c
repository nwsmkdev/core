...
=======
static struct dpl_callout survey_complete_co;
>>>>>>> Migrated survey service from os_ to dpl_.
...
=======
        dpl_callout_init(&survey_complete_co, dpl_eventq_dflt_get(), survey->survey_complete_cb, survey);
        dpl_eventq_put(dpl_eventq_dflt_get(), &survey_complete_co.co.c_ev);
>>>>>>> Migrated survey service from os_ to dpl_.
    }
}
